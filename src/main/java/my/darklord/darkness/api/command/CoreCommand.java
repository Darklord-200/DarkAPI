...
/**
 * Represents a main command that has subcommands within it. Examples: /[corecommand] [subcommand]
 */
class CoreCommand extends Command {
    ...
    public CoreCommand(String name, String description, String usageMessage, CommandList commandList,
